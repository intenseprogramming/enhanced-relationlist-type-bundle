...
class FieldValueTransformer implements DataTransformerInterface
{
    ...
    public function __construct(RelationAttributeRepository $transformer, array $configuration)
    {
    ...
    /**
     * Transforms a FieldType Value into a hash usable by the corresponding form type.
     *
     * @param mixed $value
     *
    ...
    /**
     * Transforms a hash generated by the corresponding form type into a FieldType Value.
     *
     * @param mixed $value
     *
     * @return Value
