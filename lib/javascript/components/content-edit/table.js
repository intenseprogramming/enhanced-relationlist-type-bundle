...
class TableElement extends Component {
    ...
    renderUdwPortal() {
        const config = this.props.udwConfig;
    ...
    render() {
        return (
            <div className={this.state.isValid ? '' : 'is-invalid'}>
                            ...
                            if (typeof row.value.group === 'undefined') {
                                return (
                                    <ContentRow
                                        ...
                                        toggleRemove={() => {this.props.toggleRemove(row.originalIndex)}}
...
TableElement.propTypes = {
    settings: PropTypes.shape({
        attributeDefinitions: PropTypes.array.isRequired,
